...
In Part 1, we will inspect, clean, and transform the data. In Part 2, we will use this prepared data for analysis. In this exercise, we will import our necessary libraries and read in the data.

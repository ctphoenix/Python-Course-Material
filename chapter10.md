---
title       : Case Study 7 - Movie Analysis, Part 1 - Part 2 -Modeling
...
test_student_typed("plt.show()",
              pattern=False,
              not_typed_msg="Did you call `plt.show()`?")
success_msg("Great work! it seems that omitting movies that are estimated to have made precisely no money improves the model fit.")
```
